    ...
    public void setupToolbar(){
        ...
        Drawer.Result result = new Drawer()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(R.string.str_chat).withIdentifier(3).withIcon(R.drawable.ic_chat_orange_36dp).withCheckable(false),
